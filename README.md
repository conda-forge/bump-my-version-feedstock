About bump-my-version-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/bump-my-version-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bump-my-version-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add bump-my-version
# for installing globally
pixi global install bump-my-version
```
...
It is possible to list all of the versions of `bump-my-version` available on your platform:
...
```
pixi search bump-my-version --channel conda-forge
```
